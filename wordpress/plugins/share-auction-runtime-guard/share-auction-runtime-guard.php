 ...
 * Description: Keeps the runtime on the share-auction landing and removes legacy FactoryPro plugins from activation.
 * Version: 1.0.0
 * Update URI: false
 */
...
final class Share_Auction_Runtime_Guard_Plugin
{
    ...
    {
        self::remove_factorypro_plugins();
        self::persist_theme();
    ...
    private static function remove_factorypro_plugins(): void
    {
        ...
        if (is_array($plugins)) {
            $filtered = array_values(array_filter($plugins, static function ($plugin): bool {
